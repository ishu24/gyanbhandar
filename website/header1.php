					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-12">
							<ul class="nav navbar-nav w3_agile_nav">
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span data-hover="Short Codes">Book</span> <b class="caret"></b></a>
									<ul class="dropdown-menu agile_short_dropdown">
										<li><a href="bookreg.php">New Book</a></li>
										<li><a href="viewbook.php">View Books</a></li>
										<li><a href="viewbookbyjsbn.php">View Book by JSBN</a></li>
									</ul>
								</li>
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span data-hover="Short Codes">Ishani</span> <b class="caret"></b></a>
									<ul class="dropdown-menu agile_short_dropdown">
