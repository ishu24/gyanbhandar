...
class City
{
	...
	{
		$conn=new mysqli("localhost","root","","gyanbhandar");
		$qry="SELECT * FROM `city_gyan` WHERE `City_id`='$cid'";
		$data=mysqli_query($conn,$qry);
		return $data;
		//echo $data;
	}
	...
	{
		$conn=new mysqli("localhost","root","","gyanbhandar");
		$qry="SELECT * FROM `city_gyan` WHERE `State_id`='$sid'";
		$data=mysqli_query($conn,$qry);
		return $data;
		//echo $data;
	}
	...
	{
		$conn=new mysqli("localhost","root","","gyanbhandar");
		$qry="SELECT * FROM `city_gyan` WHERE `City_name`='$cnm'";
		$data=mysqli_query($conn,$qry);
		return $data;
	}
	...
	{
			$conn=new mysqli("localhost","root","","gyanbhandar");
			$qry="SELECT * FROM `city_gyan` limit $start,$limit";
			$data=mysqli_query($conn,$qry);
			//echo $qry;
			return $data;
	}
	public function insert(City $rec)
	{
		...
		$conn=new mysqli("localhost","root","","gyanbhandar");
		$qry="INSERT INTO `city_gyan`(`City_name`,`State_id`) VALUES ('".$rec->get_City_name()."',".$rec->get_State_id().")";
		$data=mysqli_query($conn,$qry);
		//echo $qry;
	}
	...
	{
		$conn=new mysqli("localhost","root","","gyanbhandar");
		$qry="UPDATE `city_gyan` SET `City_name`='".$rec->get_City_name()."',`State_id`=".$rec->get_State_id()." WHERE `City_id`=".$rec->get_City_id()."";
		$data=mysqli_query($conn,$qry);
		//echo $qry;
	}
	...
	{
		$conn=new mysqli("localhost","root","","gyanbhandar");
		$qry="DELETE FROM `city_gyan` WHERE `City_id`=".$rec->get_City_id();
		$data=mysqli_query($conn,$qry);
		//echo $qry;	
	}
